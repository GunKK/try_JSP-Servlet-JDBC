                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="post-heading">
                            <h1>post # <small class="text-secondary"><%= post.getId() %></small></h1>
                            <h2 class="subheading"><%= post.getTitle() %></h2>
                            <span class="meta">
                                Posted by
                                <a href="#!"><%= post.getUser().getName() %></a>
                                on <%= post.getUpdatedAt() %>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <p>
                            Placeholder text by
                            <a href="http://spaceipsum.com/"><%= post.getUser().getName() %></a>
                            &middot; Images by
